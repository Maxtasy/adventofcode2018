...
def part1(input_file):
	...
	# Run just long enough for the program to finish computing its target
	# number (a handful of setup instructions), then compute the sum of its
	# divisors directly instead of brute-forcing the slow in-program loop.
	registers = run(ip_register, program, [0, 0, 0, 0, 0, 0], max_steps=200)
	n = max(registers)
